...
표에 기록한 성능 측정 run은 결과 schema `2.0`과 2D Capsule 충돌 검사를 사용했다.
그 이후 UI 확인 등으로 더 새 output 폴더가 생길 수 있으므로 표의 `결과 run`은
“현재 가장 최근 폴더”가 아니라 아래 수치를 산출한 정확한 headless run을 뜻한다.
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 01 | PASS | 4,139.066 | 0.732 | 820.000 | 250.000 | 570.000 | 100.0000 | 100.0000 | 0 | `2026-09-06_154710` |
| 02 | PASS | 1,874.880 | 0.724 | 890.330 | 250.000 | 640.330 | 99.9993 | 99.9992 | 0 | `2026-09-06_154711` |
| 03 | PASS | 2,399.240 | 0.965 | 846.833 | 250.000 | 596.833 | 99.9988 | 99.9986 | 0 | `2026-09-06_154712` |
| 04 | PASS | 1,497.859 | 0.394 | 881.040 | 250.000 | 631.040 | 99.9999 | 100.0000 | 0 | `2026-09-06_154713` |
| 05 | PASS | 1,340.264 | 0.300 | 889.858 | 250.000 | 639.858 | 100.0000 | 100.0000 | 0 | `2026-09-06_154713` |
| 06 | PASS | 1,795.068 | 0.456 | 928.205 | 250.000 | 678.205 | 100.0000 | 99.9999 | 0 | `2026-09-06_154713` |
| 07 | PASS | 3,101.609 | 2.662 | 810.024 | 250.000 | 560.024 | 99.9988 | 99.9986 | 0 | `2026-09-06_154714` |
| 08 | PASS | 2,865.785 | 1.079 | 830.332 | 250.000 | 580.332 | 99.9982 | 99.9982 | 0 | `2026-09-06_154717` |
| 09 | PASS | 2,207.881 | 0.471 | 827.517 | 250.000 | 577.517 | 100.0000 | 100.0000 | 0 | `2026-09-06_154718` |
| 10 | PASS | 1,492.319 | 0.396 | 877.133 | 250.000 | 627.133 | 99.9997 | 99.9981 | 0 | `2026-09-06_154718` |
